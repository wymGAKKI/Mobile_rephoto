...
static void draw_oxfd_features( IplImage*, feature*, int );
static void draw_oxfd_feature( IplImage*, feature*, CvScalar );
...
*/
int import_features( char* filename, int type, feature** feat )
{
    int n;
...
*/
int export_features( char* filename, feature* feat, int n )
{
    int r, type;
...
@return Returns the number of features imported from filename or -1 on error
*/
static int import_oxfd_features( char* filename, feature** features )
{
    feature* f;
    int i, j, n, d;
    double x, y, a, b, c, dv;
...
@return Returns 0 on success or 1 on error
*/
static int export_oxfd_features( char* filename, feature* feat, int n )
{
    FILE* file;
    int i, j, d;
...
@return Returns the number of features imported from filename or -1 on error
*/
static int import_lowe_features( char* filename, feature** features )
{
    feature* f;
    int i, j, n, d;
    double x, y, s, o, dv;
...
@return Returns 0 on success or 1 on error
*/
static int export_lowe_features( char* filename, feature* feat, int n )
{
    FILE* file;
    int i, j, d;
